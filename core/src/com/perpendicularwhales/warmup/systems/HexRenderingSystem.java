...
public class HexRenderingSystem extends IteratingSystem {
    ...
    public HexRenderingSystem() {
        super(Aspect.all(Sprite.class, HexPositionComponent.class, EmptyFieldComponent.class));
    ...
    protected void process(int entityId) {
        ...
        batch.draw(sprite.texture,
                ...
                sprite.texture.getWidth() / camera.zoom,
                sprite.texture.getHeight() / camera.zoom);
    }
